...
package edu.java.domain.jooq.model.tables;

import edu.java.domain.jooq.model.DefaultSchema;
import edu.java.domain.jooq.model.Keys;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.UNABLE_TO_UPDATE</code>.
     */
    public final TableField<LinkRecord, Boolean> UNABLE_TO_UPDATE =
        createField(DSL.name("UNABLE_TO_UPDATE"), SQLDataType.BOOLEAN, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super Long, ? super String, ? super OffsetDateTime, ? super Boolean, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super Long, ? super String, ? super OffsetDateTime, ? super Boolean, ? extends U> from
    ) {
