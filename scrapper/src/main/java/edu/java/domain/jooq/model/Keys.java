...
package edu.java.domain.jooq.model;

import edu.java.domain.jooq.model.tables.Chat;
import edu.java.domain.jooq.model.tables.ChatLink;
import edu.java.domain.jooq.model.tables.Link;
import edu.java.domain.jooq.model.tables.records.ChatLinkRecord;
import edu.java.domain.jooq.model.tables.records.ChatRecord;
...
public class Keys {
    ...
    public static final UniqueKey<ChatLinkRecord> CHAT_LINK_PK = Internal.createUniqueKey(ChatLink.CHAT_LINK,
        DSL.name("CHAT_LINK_PK"),
